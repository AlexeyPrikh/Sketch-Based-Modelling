...
DATASET_NPZ_PATH = 'spin/data/dataset_extras'
...
OPENPOSE_PATH = 'spin/datasets/openpose'
...
CUBE_PARTS_FILE = 'spin/data/cube_parts.npy'
JOINT_REGRESSOR_TRAIN_EXTRA = 'spin/data/J_regressor_extra.npy'
JOINT_REGRESSOR_H36M = 'spin/data/J_regressor_h36m.npy'
VERTEX_TEXTURE_FILE = 'spin/data/vertex_texture.npy'
STATIC_FITS_DIR = 'spin/data/static_fits'
SMPL_MEAN_PARAMS = 'spin/data/smpl_mean_params.npz'
SMPL_MODEL_DIR = 'spin/data/smpl'
